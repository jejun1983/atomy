...
//                (findViewById<View>(R.id.text_body) as TextView).text = message
//
...
//                Glide.with(mContext!!).load(popupUrl).into(findViewById<ImageView>(R.id.image))
//
//                findViewById<View>(R.id.btn_1_close).visibility = View.VISIBLE
//                findViewById<View>(R.id.layout_btn_2).visibility = View.GONE
//                findViewById<View>(R.id.btn_1_close).setOnClickListener(this)
...
//                (findViewById<View>(R.id.webview_popup) as WebView).loadUrl(linkUrl)
//
