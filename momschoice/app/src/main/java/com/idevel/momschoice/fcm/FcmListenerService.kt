package com.idevel.momschoice.fcm
...
import com.idevel.momschoice.activity.MainActivity
import com.idevel.momschoice.activity.PushPopupActivity
import com.idevel.momschoice.fcm.PushPreferences.PUSH_DATA
import com.idevel.momschoice.notification.PushNotification
import com.idevel.momschoice.utils.DLog
import com.idevel.momschoice.utils.SharedPreferencesUtil
import com.idevel.momschoice.utils.isAppRunning
import com.idevel.momschoice.utils.isForeground
...
class FcmListenerService : FirebaseMessagingService() {
    ...
    override fun onMessageReceived(message: RemoteMessage) {
        if (MyApplication.instance != null) {
            DLog.v("bjj FcmListenerService push isChating : " + MyApplication.instance.isChating)

            if (MyApplication.instance.isChating) {
                return
            }
        }

        val pushOnOff = SharedPreferencesUtil.getBoolean(applicationContext, SharedPreferencesUtil.Cmd.PUSH_ONOFF)
        ...
        DLog.e("bjj FcmListenerService push : "
